...
exchange = 'dydx'                        # bitmex/binance/derabits (currently only dydx is supported)
...
use_gpu = False                          # use the gpu for training (if available)

######################################################################################################
### Following indicators can be used as input features for training:
######################################################################################################
###  'vwma', 'sma', 'rsi', 'atr', 'stoch_oscilator', 'bollinger_bands_binary', 'engulfing_candle_binary', 
### 'obv_divergence_binary', 'volume_adi', 'volume_mfi', 'volatility_kchi', 'volatility_kcli', 'trend_mass_index', 
...
###
list_indicators = ['vwma', 'rsi', 'bollinger_bands_binary', 'engulfing_candle_binary', 'obv_divergence_binary', 
 'volatility_kcli', 'trend_mass_index',  'trend_aroon_down', 'trend_psar_up_indicator', 'trend_psar_down_indicator' ]
