...
str_time_horizon = '1h'                 # 30min, 1h, 2h, 3h, 4h, 6h, 8h, 12h, 24h 
utc = 0

training_start_date = '2013-01-01'       # must be greator than 2012-01-01
backtest_duration = 120                  # in days
forwardtest_duration = 60                # in days

transaction_fee_percent = 0.0           # transaction fee in percentage 0.0, 0.025, 0.05, ...
take_profit_percent = 100                  # take profit in percentage 1, 2, 3, ... 
stop_loss_percent = 100                    # stop loss in percentage 1, 2, 3, ...
